...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'devinovitaa084@gmail.com'; //email yang dirubah keamanannya
        $config['smtp_pass'] = 'ifixpyigprneptaq'; //isikan password dari kelola akun gmail
        $config['smtp_port'] = '465';
        $config['malltype'] = 'html';
        $config['charset'] = 'utf-8';
        $config['newline'] = "\r\n";
        $this->email->initialize($config);
        $this->email->from('devinovitaa084@gmail.com', 'Web Programing SMKN 8 Jember');
